...
var attrArray = ["id","adm1_code","state","barley (1,000 bushels)","bean%","chickpea%","corn%","cotton%","flaxseed%","maple%","oat%","peanut%","potato%","rice%","soybean%","sugarcane%","sunflower%","taro%","tobacco%","wheat%"]; //list of attributes
...
/*
function isDC(geojsonKey, csvKey) {
    if ((geojsonKey == "District of Columbia") && (csvKey == "Maryland")) 
        return true;
};*/
