...
function setMap(){
	...
	promises.push(d3.json("data/UsaStatesTopoJson.topojson")); //load choropleth spatial data
	...
	function callback(data){
        ...
        var statesFeature = topojson.feature(states, states.obect.UsaStatesTopoJson);
