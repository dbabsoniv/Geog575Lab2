...
var attrArray = ["state","barley","bean","chickpea","corn","cotton","flaxseed","maple","oat","peanut","potato","rice","soybean","sugarcane","sunflower","tobacco","wheat"]; //list of attributes
...
function setMap(){
    ...
    var map = d3.select("body")
        .append("svg")
        .attr("src",'https://unpkg.com/simple-statistics@7.7.6/dist/simple-statistics.min.js')
        .attr("class", "map")
        .attr("width", width)
        .attr("height", height);
